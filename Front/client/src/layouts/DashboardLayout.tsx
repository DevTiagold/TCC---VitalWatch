      ...
      <main className="min-h-screen pl-20 lg:pl-72">
        <header className="sticky top-0 z-20 border-b border-vital-border bg-white/80 px-5 py-4 backdrop-blur-xl transition-colors dark:bg-[#07111f]/80 sm:px-8 lg:px-10">
          <div className="flex items-center justify-end gap-3">
            <ThemeToggle />
            <div className="grid h-11 w-11 place-items-center rounded-full border border-vital-border bg-vital-panel text-sm font-black text-vital-blue shadow-lg shadow-slate-900/10 dark:shadow-black/20">
              A
            </div>
          </div>
        </header>
