          ...
          <div className="flex flex-col gap-6 border-t border-vital-border px-5 pb-5 pt-4">
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <ConfigField label="Muito Baixo" value={t.hr_very_low} min={0} onChange={(v) => setThreshold('hr_very_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Baixo" value={t.hr_low} min={0} onChange={(v) => setThreshold('hr_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Alto" value={t.hr_high} min={0} onChange={(v) => setThreshold('hr_high', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Muito Alto" value={t.hr_very_high} min={0} onChange={(v) => setThreshold('hr_very_high', v)} onCommit={() => publishSection('thresholds')} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <ConfigField label="Muito Baixo" value={t.hr_running_very_low} min={0} onChange={(v) => setThreshold('hr_running_very_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Baixo" value={t.hr_running_low} min={0} onChange={(v) => setThreshold('hr_running_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Alto" value={t.hr_running_high} min={0} onChange={(v) => setThreshold('hr_running_high', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Muito Alto" value={t.hr_running_very_high} min={0} onChange={(v) => setThreshold('hr_running_very_high', v)} onCommit={() => publishSection('thresholds')} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <ConfigField label="Muito Baixo" value={t.spo2_very_low} min={0} onChange={(v) => setThreshold('spo2_very_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Baixo" value={t.spo2_low} min={0} onChange={(v) => setThreshold('spo2_low', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Normal (máx)" value={t.spo2_normal} min={0} onChange={(v) => setThreshold('spo2_normal', v)} onCommit={() => publishSection('thresholds')} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <ConfigField label="Limiar de Movimento (g)" description="Aceleração mínima para detectar movimento" value={t.motion_threshold} step={0.1} min={0} onChange={(v) => setThreshold('motion_threshold', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Intervalo Mínimo (ms)" description="Mínimo entre detecções de movimento" value={t.motion_min_interval_ms} min={0} step={50} onChange={(v) => setThreshold('motion_min_interval_ms', v)} onCommit={() => publishSection('thresholds')} />
                <ConfigField label="Intervalo Máximo (ms)" description="Máximo para considerar ainda em movimento" value={t.motion_max_interval_ms} min={0} step={50} onChange={(v) => setThreshold('motion_max_interval_ms', v)} onCommit={() => publishSection('thresholds')} />
              </div>
            </div>
